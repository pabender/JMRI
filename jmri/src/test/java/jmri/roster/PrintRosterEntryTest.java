...
public class PrintRosterEntryTest {
    ...
    public void testCTorDTD() throws JDOMException, IOException {
        ...
        RosterEntry r = RosterEntry.fromFile(new File("src/test/java/jmri/roster/ACL1012-DTD.xml"));
        r.setFileName("src/test/java/jmri/roster/ACL1012-DTD.xml");
    ...
    public void testCTorSchema() throws JDOMException, IOException {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        JmriJFrame jf = new JmriJFrame("TestPrintWindow");
        RosterEntry r = RosterEntry.fromFile(new File("src/test/java/jmri/roster/ACL1012-Schema.xml"));
        r.setFileName("src/test/java/jmri/roster/ACL1012-Schema.xml");
        PrintRosterEntry t = new PrintRosterEntry(r, jf, "xml/programmers/Basic.xml");
        Assert.assertNotNull("exists", t);
        JUnitUtil.dispose(jf);
    }
