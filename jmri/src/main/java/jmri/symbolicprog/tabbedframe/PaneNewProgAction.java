...
import jmri.symbolicprog.LocoSelTreePane;
 ...
 *
 * @see jmri.symbolicprog.tabbedframe.PaneProgAction
 *
...
public class PaneNewProgAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        j.add(new jmri.decoderdefn.PrintDecoderListAction(SymbolicProgBundle.getMessage("MenuPrintDecoderDefinitions"), f, false));
        j.add(new jmri.decoderdefn.PrintDecoderListAction(SymbolicProgBundle.getMessage("MenuPrintPreviewDecoderDefinitions"), f, true));
        menuBar.add(j);
        menuBar.add(new jmri.roster.swing.RosterMenu(SymbolicProgBundle.getMessage("MenuRoster"), jmri.roster.swing.RosterMenu.MAINMENU, f));
