...
import jmri.symbolicprog.KnownLocoSelPane;
...
public class PaneEditAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        menuBar.add(new jmri.roster.swing.RosterMenu(SymbolicProgBundle.getMessage("MenuRoster"),
                jmri.roster.swing.RosterMenu.MAINMENU, f));
