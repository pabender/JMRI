 ...
 * classes.
 * <p>
 * The decoder definition {@link jmri.decoderdefn.DecoderFile.Showable}
...
//      Mouselistener for doubleclick activation of programmer
     ...
     *                  {@link jmri.decoderdefn.DecoderFile#getVersionsAsString DecoderFile.getVersionsAsString()}
     * @param comment   version string, typically from
     *                  {@link jmri.decoderdefn.DecoderFile#getModelComment DecoderFile.getModelComment()}
     *                  or
     *                  {@link jmri.decoderdefn.DecoderFile#getFamilyComment DecoderFile.getFamilyComment()}
