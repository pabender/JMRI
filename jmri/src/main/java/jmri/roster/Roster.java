...
public class Roster extends XmlFile implements RosterGroupSelector, PropertyChangeProvider, PropertyChangeListener {
     ...
     * Add a roster group, notifying all listeners of the change.
     * <p>
     * This method creates a {@link jmri.roster.rostergroup.RosterGroup}.
     * Use {@link #addRosterGroup(jmri.roster.rostergroup.RosterGroup) }
    ...
    /**
     * Add a list of {@link jmri.roster.rostergroup.RosterGroup}.
     ...
     * @see jmri.roster.swing.RenameRosterGroupAction
     */
     ...
     * {@link jmri.roster.rostergroup.RosterGroup#setName(java.lang.String)}.
     *
