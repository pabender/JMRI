...
import jmri.roster.DeleteRosterItemAction;
import jmri.roster.ExportRosterItemAction;
import jmri.roster.FullBackupExportAction;
import jmri.roster.FullBackupImportAction;
import jmri.roster.ImportRosterItemAction;
import jmri.roster.PrintListAction;
import jmri.roster.PrintRosterAction;
import jmri.roster.swing.speedprofile.SpeedProfileAction;
...
public class RosterMenu extends JMenu {
    ...
    public RosterMenu(String pMenuName, int pMenuType, Component pWho) {
        ...
        AbstractAction rosterGroupTableAction = new jmri.roster.swing.rostergroup.RosterGroupTableAction(Bundle.getMessage("MenuGroupTable"));
