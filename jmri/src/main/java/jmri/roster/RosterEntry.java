...
public class RosterEntry extends ArbitraryBean implements RosterObject, BasicRosterEntry {
     ...
     * {@link jmri.roster.rostergroup.RosterGroup}s from the default
     * {@link jmri.roster.Roster} if they exist.
     *
    ...
    /**
     * List the roster groups this entry is a member of, returning existing
     * {@link jmri.roster.rostergroup.RosterGroup}s from the specified
     * {@link jmri.roster.Roster} if they exist.
     *
