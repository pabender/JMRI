...
public class SensorTableAction extends AbstractTableAction<Sensor> {
    ...
    protected void createModel() {
        m = new jmri.beantable.sensor.SensorTableDataModel(sensorManager);
    }
    ...
    void showDebounceChanged() {
        jmri.beantable.sensor.SensorTableDataModel a = (jmri.beantable.sensor.SensorTableDataModel) m;
