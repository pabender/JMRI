...
import jmri.beantable.signalmast.SignalMastTableDataModel;
...
public class SignalMastTableAction extends AbstractTableAction<SignalMast> {
    ...
    jmri.beantable.signalmast.AddSignalMastJFrame addFrame = null;
    ...
    protected void addPressed(ActionEvent e) {
        if (addFrame == null) {
            addFrame = new jmri.beantable.signalmast.AddSignalMastJFrame();
        } else {
            addFrame.refresh();
        }
    ...
    public void setMenuBar(BeanTableFrame f) {
        ...
        item.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                jmri.beantable.signalmast.SignalMastRepeaterJFrame frame = new jmri.beantable.signalmast.SignalMastRepeaterJFrame();
