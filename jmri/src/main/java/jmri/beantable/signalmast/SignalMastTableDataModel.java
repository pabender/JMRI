...
public class SignalMastTableDataModel extends BeanTableDataModel<SignalMast> {
    ...
    void editMast(int row, int col) {
        class WindowMaker implements Runnable {
            ...
            @Override
            public void run() {
                AddSignalMastJFrame editFrame = new jmri.beantable.signalmast.AddSignalMastJFrame(getBySystemName(sysNameList.get(row)));
    ...
    protected String getClassName() {
        return jmri.beantable.SignalMastTableAction.class.getName();
    }
