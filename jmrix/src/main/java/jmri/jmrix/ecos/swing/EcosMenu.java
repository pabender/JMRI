...
public class EcosMenu extends JMenu {
    ...
    public EcosMenu(EcosSystemConnectionMemo memo) {
        ...
        if (jmri.InstanceManager.getNullableDefault(jmri.beantable.ListedTableFrame.class) == null) {
            try {
        ...
        add(new jmri.beantable.ListedTableAction(Bundle.getMessage("MenuItemDatabase"), "jmri.jmrix.ecos.swing.locodatabase.EcosLocoTableTabAction"));
